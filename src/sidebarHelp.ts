...
export function registerSidebarHelp(context: vscode.ExtensionContext) {
    ...
    const entries: LinkEntry[] = [
        ...
        createKeyEntry('GitHub repository', 'mark-github', 'https://github.com/simplelocalize/vscode-simplelocalize'),
        createKeyEntry('Report issue', 'bug', 'https://github.com/simplelocalize/vscode-simplelocalize/issues'),
        createKeyEntry('Feature requests', 'lightbulb', 'https://github.com/simplelocalize/vscode-simplelocalize/issues'),
